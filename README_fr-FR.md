...
Un guide pour comprendre l'importance des messages a l'interieur des commit et comment les écrires de la meilleurs façon.
...
Ce guide peut etre utile pour apprendre ce qu'est un commit, pourquoi il est important d'écrire des messages pertinent. Ce guide permet également d'acquerir les meilleurs pratiques, et quelques conseils pour (ré)écrire un bon historique de commit.

## Available languages

- [English](README.md)
- [Francais](README_fr-FR.md)
...
En quelques mots, un commit est une capture a un moment donné de vos fichiers de votre projet, enregistré dans votre depôt GIT local. [GIT ne conserve pas la difference entre les fichiers, GIT conserve la version complète de tout les fichiers](https://git-scm.com/book/eo/v1/Ekkomenci-Git-Basics#Snapshots,-Not-Differences).Pour tous les fichiers qui n'ont pas changé d'un commit a l'autre, GIT conserve seulement un lien identique de la précedente version du fichier qui etait deja conservé.

L'image ci-dessous montre comment GIT conserve les données dans le temps, et dans quelle version chaque commit appartient:
